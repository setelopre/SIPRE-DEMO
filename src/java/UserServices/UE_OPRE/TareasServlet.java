...
public class TareasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objBnTarea.getMode().equals("G")) {
            objTareas = objDsTarea.getListaTareas(usuario);
        }
        if (objBnTarea.getMode().equals("U")) {
            objBnTarea = objDsTarea.getTareas(objBnTarea, usuario);
        ...
        switch (request.getParameter("mode")) {
            case "tareas":
                dispatcher = request.getRequestDispatcher("Ejemplo/Tareas.jsp");
                break;
            case "G":
                dispatcher = request.getRequestDispatcher("Ejemplo/ListaTareas.jsp");
                break;
            default:
